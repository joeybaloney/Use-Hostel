...
%Mixing up yesterday's ancestors with
%tomorrow's cinammon toast.
...
%, don't even ask what he does with the thing,
%for all I know he jumps rope with it.
Shortman has a saying:  ``Life is nothing but a drug called \emph{umbilical cord}.''
%Doc laughs and says:  ``I might be the only man who still feeds through the
...
% More stuff for this chapter:
% The Nobel prize committee comes to take back Doc's medals, and given them
% to another author, a fat ugly old woman who's obviously just bribing them
% for the prizes.
%
% The 72 brides throw themselves off the Use Hostel in a mass suicide.
% They become a tangled blob of corpses down below, Tallman and Shortman and I
% have to bury them with a bulldozer.  They go to Heaven still in blob-of-
% flesh form, where Doc (still as a dog named Dada) humps their legs for
% eternity despite their pleading "No! Bad Dada!"
%
% They find Doc's hoarded cereal
%
% They attempt unsuccessfully, to find a genius to replace Doc, by putting
% a lot of kids in a room with a red hot typewriter, whipping them and
% ordering them to type on it
%
...
% Then write job #2: Mr. Capiche has kidnapped a blogger, and in order
% to avoid suspicion from the authorities, he needs us to write a blog
% post in his name, so people don't notice he's missing.
% We write the blog post from in the blogger's room, where he's tied
% up and being tortured by Mr. Capiche's goons.  Mr. Capiche instructed
% us to read a few posts first so our contribution isn't too jarring,
% but Tallman decides to ignore those instructions.  With no idea what
% kinds of things the dude blogs about, we write the article:
% "The Modern SPQR", a fictional description of the Roman Senate, which
% still meets to this day and has always met since the days of ancient
% Rome, only, since Rome fell, they live in obscurity, meeting in a public
% library meeting room (having to fight with other groups to get it),
% all the senators have day-jobs and do this on the side, some of them are
% even so ashamed of it that they hide it from their families, instead telling
% their wives that they're "going out to get drunk".  They're divided into
% three bitterly opposed factions:  the pro-Latin faction, the pro-Italian
% faction, and the pro-English faction.  They DO get paid for their work, but
% it's a ludicrously tiny paycheck, such that it's more of an insult than a
% help.  This is despite their constant, incessant votes to raise their own
% paycheck, which the real government always promptly ignores.  (The real
% government being Mr. Capiche and his men, of course.)  
